...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  return (
    <>
      {showNotification ? (
        <div className="fixed text-sm left-1/2 max-w-[90vw] -translate-x-1/2 flex top-6 items-center gap-4 px-4 py-3 rounded-lg border"
             style={{ backgroundColor: 'rgba(219, 231, 237, 0.1)', borderColor: 'rgba(219, 231, 237, 0.2)', color: '#DBE7ED' }}>
          <div>
            {/* Warning Icon */}
            <svg
              width="24"
